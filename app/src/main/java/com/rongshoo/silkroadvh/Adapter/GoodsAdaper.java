 ...
 */
public class GoodsAdaper extends BaseQuickAdapter<GoodsListBean.DataBean.RowsBean, BaseViewHolder> {

    //alt+insert constructor 快速构造方法
    public GoodsAdaper(int layoutResId, List<GoodsListBean.DataBean.RowsBean> data) {
        super(layoutResId, data);
    }

    // 第二种
    public GoodsAdaper(List<GoodsListBean.DataBean.RowsBean> data) {
