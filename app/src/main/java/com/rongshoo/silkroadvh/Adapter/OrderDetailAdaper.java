 ...
 */
public class OrderDetailAdaper extends BaseQuickAdapter<Map<String,Object>, BaseViewHolder> {

    //alt+insert constructor 快速构造方法
    public OrderDetailAdaper(int layoutResId, List<Map<String,Object>> data) {
        super(layoutResId, data);
    }

    // 第二种
    public OrderDetailAdaper(List<Map<String,Object>> data) {
