 ...
 */
public class MineAdaper extends BaseQuickAdapter<Map<String,Object>, BaseViewHolder> {

    //alt+insert constructor 快速构造方法
    public MineAdaper(int layoutResId, List<Map<String,Object>> data) {
        super(layoutResId, data);
    }

    // 第二种
    public MineAdaper(List<Map<String,Object>> data) {
