 ...
 */
public class CollectedAdaper extends BaseQuickAdapter<Map<String,Object>, BaseViewHolder> {

    //alt+insert constructor 快速构造方法
    public CollectedAdaper(int layoutResId, List<Map<String,Object>> data) {
        super(layoutResId, data);
    }

    // 第二种
    public CollectedAdaper(List<Map<String,Object>> data) {
        super(R.layout.item_goods_collected, data);
    }
    ...
    protected void convert(BaseViewHolder baseViewHolder, Map<String,Object> map) {
        ...
        baseViewHolder.addOnClickListener(R.id.goods_del);
