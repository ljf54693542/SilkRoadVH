 ...
 */
public class MineTalkAdaper extends BaseQuickAdapter<Map<String,Object>, BaseViewHolder> {

    //alt+insert constructor 快速构造方法
    public MineTalkAdaper(int layoutResId, List<Map<String,Object>> data) {
        super(layoutResId, data);
    }

    // 第二种
    public MineTalkAdaper(List<Map<String,Object>> data) {
        super(R.layout.item_mine_talk, data);
    }
